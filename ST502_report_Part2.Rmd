...
\captionof{figure}{\bf Approximate alpha curves of the Pooled and Satterthwaite t-tests for different sample sizes and population variances}
\label{f: alpha}
