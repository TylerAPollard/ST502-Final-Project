...
\begin{figure}\caption{{\bf yadayadayada}\label{f:nonsmokers_hist}}
\centering 
\includegraphics[page=1,width=1.05\textwidth]{nonsmokers_qq}
\end{figure}

\begin{figure}\caption{{\bf yadayadayada}\label{f:smokers_hist}}
\centering 
\includegraphics[page=1,width=1.05\textwidth]{smokers_qq}
\end{figure}
...
\begin{figure}\caption{{\bf yadayadayada}\label{f:nonsmokers_qq}}
\centering 
\includegraphics[page=1,width=1.05\textwidth]{nonsmokers_qq}
\end{figure}

\begin{figure}\caption{{\bf yadayadayada}\label{f:smokers_qq}}
\centering 
\includegraphics[page=1,width=1.05\textwidth]{smokers_qq}
\end{figure}
...
There is no indication that the true population variances are equal. To ensure robustness to the assumption of equal variances, we concluded that the t-test with the Satterthwaite approximation is preferred.
